...
if __name__=="__main__":
    ...
    algos = ["jactivemodules_greedy", "jactivemodules_sa", "bionet", "netbox", "keypathwayminer_INES_GREEDY", "DOMINO", "DOMINO2", "hotnet2"]
    datasets = ['DOMINO3', 'netbox3'] # ["tnfa", "hc", "ror", "shera", "shezh", "ers", "iem", "apo", "cbx", "ift"]
    ...
    suffix = "{}_100".format(prefix)
    zeros_file_name =  zeros_file_format.format(prefix)
    algos = ['DOMINO3','netbox3']# ["jactivemodules_greedy", "jactivemodules_sa", "bionet", "netbox", "keypathwayminer_INES_GREEDY", "DOMINO", "DOMINO2","hotnet2"]
