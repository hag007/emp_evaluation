    ...
    for n_modules_th in range(1, MAX_N_MODULES_TH + 1):
        ...
        for cur_ds in datasets:
            for cur_alg in algos:
                ...
                for cur in range(max(1, min(n_modules_th, len(l_modules)))):
...
if __name__ == "__main__":
    ...
    algos = ["netbox2_string", "DOMINO4"] # ["DOMINO", "DOMINO2", "netbox", "jactivemodules_greedy", "jactivemodules_sa", "bionet", "keypathwayminer_INES_GREEDY", "hotnet2"]
    prefix = "GE"
