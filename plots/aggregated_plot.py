...
if __name__ == "__main__":
    ...
    algos = ["jactivemodules_greedy", "jactivemodules_sa", "bionet", "netbox",  "DOMINO", "keypathwayminer_INES_GREEDY", "hotnet2"] # "keypathwayminer_INES_GREEDY",
    datasets = ["tnfa", "hc", "ror", "shera", "shezh", "ers", "iem", "apo", "cbx", "ift"]
    main(prefix, algos, datasets)

    prefix = "PASCAL_SUM" # "GE" # PASCAL_SUM
    algos = ["jactivemodules_greedy", "jactivemodules_sa", "bionet", "netbox",  "DOMINO", "keypathwayminer_INES_GREEDY", "hotnet2"]
