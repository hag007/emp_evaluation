...
if __name__ == "__main__":
    ...
    root_folder="/media/hag007/Data/DOMINO_amit/"
    report_folder="/media/hag007/Data/DOMINO_amit/report/report"
    network_file_name=os.path.join(root_folder,"network/dip_mouse.sif")
    constants.TRUE_SOLUTIONS_DIR=report_folder
    module_name_format="{}/{}_module_genes_{{}}.txt".format(report_folder,algo)
    modules_summary_file="{}/modules_summary.tsv".format(report_folder)
    ...
    build_all_reports(algo+strategy, dataset_name, modules, all_bg_genes, None, network_file_name)
