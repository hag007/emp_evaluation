...
if __name__ == "__main__":
    ...
    for datasets,prefix in [(["TNFa_2", "HC12", "SHERA", "ROR_1", "SHEZH_1", "ERS_1", "IEM", "APO", "CBX", "IFT"], "GE"), (["Breast_Cancer.G50", "Crohns_Disease.G50", "Schizophrenia.G50", "Triglycerides.G50", "Type_2_Diabetes.G50","Coronary_Artery_Disease.G50","Bone_Mineral_Density.G50","Height1.G50","Alzheimer.G50","Age_Related_Macular_Degeneration.G50","Atrial_Fibrillation.G50"], "PASCAL_SUM")]:
