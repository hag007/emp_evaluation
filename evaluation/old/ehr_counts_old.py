...
def main(algo_sample = None, dataset_sample = None,tsv_file_name=os.path.join(constants.OUTPUT_GLOBAL_DIR, "emp_fdr", "MAX", "emp_diff_{}_{}_md.tsv")):
    ...
    sorted_genes_emp.loc[sorted_genes_emp['emp_pval']==0,'emp_pval']=1.0/5000
...
if __name__ == "__main__":
    ...
    for cur_ds in datasets:
        ...
        for cur_alg in algos:
            ...
            df_ds.loc["{}_{}".format(cur_ds,cur_alg),"n_emp"]=len(sig_emp_genes[sig_emp_genes["passed_oob_permutation_test"]].index)
