...
def summarize_modules_ehr(prefix, datasets, algos, base_folder, terms_file_name_format="emp_diff_modules_{}_{}_passed_oob.tsv"):
    ...
    for cur_ds in datasets:
        for cur_alg in algos:
            ...
            modules_file_name = os.path.join(constants.TRUE_SOLUTIONS_DIR, "{}_{}".format(cur_ds, cur_alg), "report", "modules_summary.tsv")


            res=modules_ehr_for_solution(cur_alg, cur_ds, prefix, terms_file_name=terms_file_name, modules_file_name=modules_file_name)
    ...
    df_statistics.to_csv(os.path.join(constants.OUTPUT_GLOBAL_DIR, "module_cache_files", "modules_statistics_{}.tsv".format(prefix)), sep='\t')
    df_full_data.to_csv(os.path.join(constants.OUTPUT_GLOBAL_DIR, "module_cache_files", "modules_full_data_{}.tsv".format(prefix) ), sep='\t')


def modules_ehr_for_solution(algo_sample = None, dataset_sample = None, prefix=None, terms_file_name=os.path.join(constants.OUTPUT_GLOBAL_DIR, "oob", "emp_diff_{}_{}_oob.tsv"),
    ...
    if n_modules==0:
        a=0
        statistics["module_{}_emp_ratio".format(a)]=0
        statistics["module_{}_tp".format(a)] = 0
        statistics["module_{}_fp".format(a)] =0
        statistics["module_{}_total".format(a)] = 0
        statistics["module_{}_size".format(a)] = 0
 
        full_data.loc["{}_{}_module_{}".format(dataset_sample, algo_sample, a), "EHR"] = 0
        full_data.loc["{}_{}_module_{}".format(dataset_sample, algo_sample, a),"tp"]=0
        full_data.loc["{}_{}_module_{}".format(dataset_sample, algo_sample, a),"fp"]=0
        # full_data.loc["{}_{}_module_{}".format(dataset_sample, algo_sample, a),"genes"] =
        full_data.loc["{}_{}_module_{}".format(dataset_sample, algo_sample, a), "module_size".format(a)] = 0
    ...
    file_name=os.path.join(constants.OUTPUT_GLOBAL_DIR, "module_cache_files", "full_modules_report_{}_{}.tsv".format(algo_sample, dataset_sample))
