...
def compute_redundancy_for_solution(cutoff, cur_ds, cur_algo):
...
def compute_redundancy_for_solutions(datasets, algos, pf=10, sim_method='Resnik', cutoffs=[1.0, 2.0, 3.0, 4.0], base_folder=None, file_format=None):
    ...
    for cutoff in cutoffs:
        ...
        for cur_ds in datasets:
            ...
            for i_algo, cur_algo in enumerate(algos):
                params.append([compute_redundancy_for_solution,[cutoff, cur_ds, cur_algo]])
...
if __name__ == "__main__":
    ...
    compute_redundancy_for_solutions(datasets=datasets, algos=algos, pf=pf, base_folder=base_folder, file_format=file_format, sim_method=sim_method, cutoffs=cutoffs)
