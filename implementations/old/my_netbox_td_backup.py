...
def main(dataset_name="PASCAL_SUM_Breast_Cancer2.G50", score_file_name="/media/hag007/Data/bnet/datasets/GE_HC12/output/ge_list.txt", network_file_name="dip.sif", modules_file_name=os.path.join(constants.NETWORKS_DIR, "dip_ng_modularity_components.txt")):
    ...
    G_modularity, optimized_connected_components, qvals = leave_significant_modules(G, G_modularity)
