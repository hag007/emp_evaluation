...
class HeatDiffusionService():
    ...
    def add_heat(self, network, output_key, heat_array):
        ...
        networkx.set_node_attributes(network, node_heat, name=output_key+'_heat')
        networkx.set_node_attributes(network, node_rank, name=output_key+'_rank')
        return network
